...
export default function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] flex justify-around items-center px-4 pb-6 pt-3 rounded-t-[2rem] border-t border-white/5 z-50"
      style={{
      ...
      {NAV_ITEMS.map(({ href, label, icon }) => {
        ...
        return (
          ...
          >
            ...
            <span className="text-[10px] font-bold tracking-[2px] mt-1" style={{ fontFamily: "var(--font-mono)" }}>
              {label}
            </span>
          </Link>
        );
